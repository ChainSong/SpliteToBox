...
namespace AllocationPickTask.Model
{
    public class PickTaskDetail
    {
        ...
        [EntityPropertyExtension("PTID", "PTID")]
        public long PTID { get; set; }

        [EntityPropertyExtension("ODID", "ODID")]
        public long ODID { get; set; }

        [EntityPropertyExtension("PickTaskNumber", "PickTaskNumber")]
        ...
        [EntityPropertyExtension("PickQty", "PickQty")]
        public decimal PickQty { get; set; }

        [EntityPropertyExtension("PackageQty", "PackageQty")]
        ...
        [EntityPropertyExtension("BoxLineNo", "BoxLineNo")]
        public string BoxLineNo { get; set; }
        ...
        /// 表示是整箱
        /// </summary>
        [EntityPropertyExtension("IsFCL", "IsFCL")]
        ...
        [EntityPropertyExtension("Volumn", "Volumn")]
