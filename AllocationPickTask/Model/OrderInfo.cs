...
namespace AllocationPickTask.Model
{
    ...
    {
        [EntityPropertyExtension("SeqNo", "SeqNo")]
        public string SeqNo { get; set; }
        [EntityPropertyExtension("OAID", "OAID")]
        public string OAID { get; set; }
        [EntityPropertyExtension("wmsCode", "wmsCode")]
        ...
        [EntityPropertyExtension("PickingTask", "PickingTask")]
        public string PickingTask { get; set; }

        [EntityPropertyExtension("Lpcode", "Lpcode")]
        public string Lpcode { get; set; }

        [EntityPropertyExtension("outboundTargetWhName", "outboundTargetWhName")]
        public string outboundTargetWhName { get; set; }
        ...
        /// 菜鸟面单打印专用
        /// </summary>
        [EntityPropertyExtension("printData", "printData")]
        public string printData { get; set; }

        /// <summary>
        /// FF极效前置
        /// </summary>
        [EntityPropertyExtension("fast_forward", "fast_forward")]
        public string fast_forward { get; set; }
        /// <summary>
        /// nikeSF直发
        /// </summary>
        [EntityPropertyExtension("direct_send", "direct_send")]
        public string direct_send { get; set; }

        /// <summary>
        /// FF极效前置
        /// </summary>
        [EntityPropertyExtension("DN", "DN")]
        public string DN { get; set; }
        /// <summary>
        /// nikeSF直发
        /// </summary>
        [EntityPropertyExtension("SO", "SO")]
